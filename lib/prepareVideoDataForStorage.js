    ...
    return {
        ...
        videos: data.videos.map(video => {
            ...
            while (trendStatistics[index]) {
                ...
                const popularityGainInPercent = Math.round(popularityGain / previousPopularity) * 100;

                popularityGainLookingBack.push(popularityGainInPercent);
            ...
            if (popularityGainLookingBack.length > 1) {
                ...
                const averagePopularityGain = previousPopularityGains.reduce((sum, popularityGain) => sum + popularityGain, 0) / previousPopularityGains.length;

                trend = Math.floor(100 + currentPopularityGain - averagePopularityGain);
            }
